...
Регистрируюсь на приведённых в задачах сайтах и вставляю ссылки в index.md (рис. @fig:001).
...
Пишу пост по теме на выбор. Моя тема - Оформление отчёта (рис. @fig:003, рис. @fig:004).
